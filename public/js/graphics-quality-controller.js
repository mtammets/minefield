...
const QUALITY_PROFILES = {
    quality: {
        ...
        mapProfile: {
            minimapMaxDpr: 2,
            worldMapMaxDpr: 2,
            minimapDrawIntervalSec: 1 / 36,
            worldMapDrawIntervalSec: 1 / 30,
            labelUpdateIntervalSec: 1 / 11,
            entitySyncIntervalSec: 1 / 36,
            routeRebuildIntervalSec: 0.13,
            routeRebuildDistanceSq: 1.8 * 1.8,
        },
        skidProfile: {
            maxSmokeParticles: 260,
    ...
    balanced: {
        ...
        mapProfile: {
            ...
            labelUpdateIntervalSec: 1 / 12,
            entitySyncIntervalSec: 1 / 28,
            routeRebuildIntervalSec: 0.16,
            routeRebuildDistanceSq: 2.2 * 2.2,
        },
        skidProfile: {
            maxSmokeParticles: 180,
            smokeSpawnRateMultiplier: 0.78,
            maxEmissionPerFrame: 9,
        },
    ...
    performance: {
        ...
        mapProfile: {
            minimapMaxDpr: 1.25,
            worldMapMaxDpr: 1.25,
            minimapDrawIntervalSec: 1 / 20,
            worldMapDrawIntervalSec: 1 / 16,
            labelUpdateIntervalSec: 1 / 8,
            entitySyncIntervalSec: 1 / 20,
            routeRebuildIntervalSec: 0.24,
            routeRebuildDistanceSq: 3.2 * 3.2,
        },
        skidProfile: {
            maxSmokeParticles: 110,
            smokeSpawnRateMultiplier: 0.52,
            maxEmissionPerFrame: 6,
        },
